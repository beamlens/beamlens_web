...
- Unit tests: `test/beamlens_web/*_test.exs`
- Test support: `test/support/`

## Review Checklist

For each changed module in `lib/beamlens_web/`:
...
2. **LiveView Test Coverage**
   - LiveView components have mount tests
   - Event handlers tested
   - Socket assigns verified
