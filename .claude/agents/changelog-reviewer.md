...
Bad: "Refactored DashboardLive to use notification_counts assign"
Good: "Renamed 'Alerts' to 'Notifications' throughout the dashboard"

Bad: "Fixed race condition in EventStore GenServer handle_info callback"
Good: "Fixed intermittent event display issues under high load"
